...
public class HTMLPublisherConverterTest
{
        ...
        throws Exception
    {
        ...
        HtmlPublisherTarget
            htmlPublisherTarget = new HtmlPublisherTarget( "reportName", "reportDir", "reportFiles", /*keepAll*/true,
        ...
        HTMLPublisherConverter converter = j.jenkins.getExtensionList( HTMLPublisherConverter.class ).get( 0 );
