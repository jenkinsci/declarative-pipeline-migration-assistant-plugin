...
public class ToDeclarativeActionTest {
    ...
    public void simpleActionRun() throws Exception {
        ...
        ToDeclarativeAction.ToDeclarativeActionDescriptor actionDescriptor = j.jenkins
                .getExtensionList(ToDeclarativeAction.ToDeclarativeActionDescriptor.class)
                .get(0);

        ToDeclarativeAction.ActionInjector actionInjector = j.jenkins
                .getExtensionList(ToDeclarativeAction.ActionInjector.class)
                .get(0);
    ...
    public void requires_configure_permission() throws Exception {
        ...
        try (ACLContext unused = ACL.as(User.getOrCreateByIdOrFullName("bob"))) {
            ...
            assertThat(
                    e.getMessage(),
                    is(hudson.security.Messages.AccessDeniedException2_MissingPermission("bob", "Job/Configure")));
        }
