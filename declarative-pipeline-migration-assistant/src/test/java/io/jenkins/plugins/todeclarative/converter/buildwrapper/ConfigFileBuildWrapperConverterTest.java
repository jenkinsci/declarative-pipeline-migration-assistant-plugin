...
public class ConfigFileBuildWrapperConverterTest {
    ...
    public void simpletest() throws Exception {
        ConfigFileBuildWrapperConverter converter = j.jenkins
                .getExtensionList(ConfigFileBuildWrapperConverter.class)
                .get(0);
    ...
    @Test
    public void simpletestemptyvalues() throws Exception {
        ConfigFileBuildWrapperConverter converter = j.jenkins
                .getExtensionList(ConfigFileBuildWrapperConverter.class)
                .get(0);
