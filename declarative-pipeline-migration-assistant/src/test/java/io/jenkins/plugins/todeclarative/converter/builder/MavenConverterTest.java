...
public class MavenConverterTest {
    ...
    @Test
    public void simpleMavenConversion() throws Exception {
        ...
        Maven maven = new Maven(
                ...
                true /*usePrivateRepository*/,
                settingsProvider /*SettingsProvider settings*/,
                globalSettingsProvider /*GlobalSettingsProvider*/);

        MavenConverter mavenConverter =
                j.jenkins.getExtensionList(MavenConverter.class).get(0);
    ...
    @Test
    public void simpleMavenConversionNoJDKNoMaven() throws Exception {
    ...
    @Test
    public void simpleMavenConversionNoValues() throws Exception {
