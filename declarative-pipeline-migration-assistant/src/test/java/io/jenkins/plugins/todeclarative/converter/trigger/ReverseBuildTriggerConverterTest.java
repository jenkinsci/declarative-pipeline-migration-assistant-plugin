...
public class ReverseBuildTriggerConverterTest {
    ...
    public void simpletest() throws Exception {
        ...
        ReverseBuildTriggerConverter converter =
                j.jenkins.getExtensionList(ReverseBuildTriggerConverter.class).get(0);
    ...
    @Test
    public void simpletestwiththreshold() throws Exception {
        String projectName = Long.toString(System.currentTimeMillis());
        FreeStyleProject p = j.createFreeStyleProject(projectName);
