...
public class BuildDiscarderPropertyConverterTest {
    ...
    public void simpletest() throws Exception {
        ...
        BuildDiscarderPropertyConverter converter = j.jenkins
                .getExtensionList(BuildDiscarderPropertyConverter.class)
                .get(0);
    ...
    @Test
    public void simpletestnullvalues() throws Exception {
        String projectName = Long.toString(System.currentTimeMillis());
        FreeStyleProject p = j.createFreeStyleProject(projectName);
